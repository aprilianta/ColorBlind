...
public class simulasi2 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_simulasi2);
        ...
        btnkirim.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                cek();
                Intent intent = new Intent(simulasi2.this, simulasi3.class);
    ...
    public void cek() {
        ...
        if (intent.getStringExtra("jumlah").equals("1")) {
            benar=1; salah=0;
    ...
    public void onBackPressed() {
        AlertDialog.Builder alert = new AlertDialog.Builder(simulasi2.this);
        alert.setTitle("Konfirmasi");
        alert.setMessage("Yakin ingin mengakhiri simulasi?");
        alert.setPositiveButton("Ya", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int which) {
                total=0;
                startActivity(new Intent(simulasi2.this, MainActivity.class));
                finish();
            }
        });
