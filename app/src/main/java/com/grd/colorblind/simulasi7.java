...
public class simulasi7 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_simulasi7);
        ...
        btnkirim.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                cek();
                Intent intent = new Intent(simulasi7.this, simulasi8.class);
    ...
    public void cek() {
        ...
        if (intent.getStringExtra("jumlah").equals("6")) {
            benar=6; salah=0;
    ...
    public void onBackPressed() {
        AlertDialog.Builder alert = new AlertDialog.Builder(simulasi7.this);
        alert.setTitle("Konfirmasi");
        alert.setMessage("Yakin ingin mengakhiri simulasi?");
        alert.setPositiveButton("Ya", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int which) {
                total=0;
                startActivity(new Intent(simulasi7.this, MainActivity.class));
                finish();
            }
        });
