...
public class simulasi8 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_simulasi8);
        ...
        btnkirim.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                cek();
                Intent intent = new Intent(simulasi8.this, simulasi9.class);
    ...
    public void cek() {
        ...
        if (intent.getStringExtra("jumlah").equals("7")) {
            benar=7; salah=0;
    ...
    public void onBackPressed() {
        AlertDialog.Builder alert = new AlertDialog.Builder(simulasi8.this);
        alert.setTitle("Konfirmasi");
        alert.setMessage("Yakin ingin mengakhiri simulasi?");
        alert.setPositiveButton("Ya", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int which) {
                total=0;
                startActivity(new Intent(simulasi8.this, MainActivity.class));
                finish();
            }
        });
