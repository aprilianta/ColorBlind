...
public class simulasi4 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_simulasi4);
        ...
        btnkirim.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                cek();
                Intent intent = new Intent(simulasi4.this, simulasi5.class);
    ...
    public void cek() {
        ...
        if (intent.getStringExtra("jumlah").equals("3")) {
            benar=3; salah=0;
    ...
    public void onBackPressed() {
        AlertDialog.Builder alert = new AlertDialog.Builder(simulasi4.this);
        alert.setTitle("Konfirmasi");
        alert.setMessage("Yakin ingin mengakhiri simulasi?");
        alert.setPositiveButton("Ya", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int which) {
                total=0;
                startActivity(new Intent(simulasi4.this, MainActivity.class));
                finish();
            }
        });
