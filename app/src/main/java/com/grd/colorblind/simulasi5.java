...
public class simulasi5 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_simulasi5);
        ...
        btnkirim.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                cek();
                Intent intent = new Intent(simulasi5.this, simulasi6.class);
    ...
    public void cek() {
        ...
        if (intent.getStringExtra("jumlah").equals("4")) {
            benar=4; salah=0;
    ...
    public void onBackPressed() {
        AlertDialog.Builder alert = new AlertDialog.Builder(simulasi5.this);
        alert.setTitle("Konfirmasi");
        alert.setMessage("Yakin ingin mengakhiri simulasi?");
        alert.setPositiveButton("Ya", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int which) {
                total=0;
                startActivity(new Intent(simulasi5.this, MainActivity.class));
                finish();
            }
        });
